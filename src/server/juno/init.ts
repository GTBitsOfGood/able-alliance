...
console.log("JUNO_API_KEY:", process.env.JUNO_API_KEY ? `${process.env.JUNO_API_KEY.substring(0, 10)}...` : "NOT SET");
console.log("JUNO_BASE_URL:", process.env.JUNO_BASE_URL || "https://api-gateway.whitesmoke-cea9a269.eastus.azurecontainerapps.io/");
...
juno.init({
  ...
  baseURL:
    process.env.JUNO_BASE_URL || "https://api-gateway.whitesmoke-cea9a269.eastus.azurecontainerapps.io/",
});
