...
interface BogCheckboxProps extends React.ComponentProps<typeof Checkbox.Root> {
  ...
  className?: string;
  /**
   * Additional CSS styles (applied to the wrapper). To change checkbox colors, pass CSS variables:
   * - --color-brand-text: checked/indeterminate background
   * - --color-brand-stroke-strong: border when hover or checked
   * - --checkbox-indicator-color: checkmark/minus icon color (default: white)
   */
